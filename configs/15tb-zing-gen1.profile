#!/bin/bash
# ReadyNow Generation 1 - Refined Profile Collection
# This run uses Gen0 profile as input and produces a refined Gen1 profile

PROFILE_NAME="zing-gen1-3i-8t-11e-8c-full-15tb"
...
# Generation 1: Use Gen0 profile as input, collect refined Gen1 profile
# - ProfileLogIn: Reads the previously collected Gen0 profile for warm-start optimization
# - ProfileLogOut: Creates a new Gen1 profile with improved coverage
# NOTE: You must upload tpcds-15tb-full-gen0.profile to /mnt/vmoutput/ via bootstrap.sh.tpl
