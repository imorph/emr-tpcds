#!/bin/bash
# ReadyNow Generation 0 - Initial Profile Collection
# This is the first training run that collects baseline JIT compilation data

PROFILE_NAME="zing-gen0-3i-8t-11e-8c-full-15tb"
...
# Generation 0: Collect initial ReadyNow profile
# - TopTierCompileThresholdTriggerMillis=60000: Allows 60 seconds for methods to stabilize before top-tier compilation
# - ActiveProcessorCount=8: Matches SPARK_EXECUTOR_CORES to ensure consistent resource allocation
# - ProfileLogOut: Each executor creates a profile file with its process ID (%p)
